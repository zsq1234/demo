...
def make_crf_train_label_L2_data(seg_file, label_file, output_file):
    """将数据转为CRF可识别的L2训练数据"""
    seg_data = codecs.open(seg_file, 'r', 'utf-8')
    label_data = codecs.open(label_file, 'r', 'utf-8')
    output_data = codecs.open(output_file, 'w', 'utf-8')
...
if __name__ == '__main__':
    if len(sys.argv) == 4:
        ...
        label_file = '../../data/raw/000001-007000.txt'
        seg_file = '../../data/tmp/000001-007000_seg_data.txt'
        output_file = '../../data/train/train_label_L2_data.txt'
        # input_file = '4.txt'
        # output_file = '2.txt'

    make_crf_train_label_L2_data(seg_file, label_file, output_file)
